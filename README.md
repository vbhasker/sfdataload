This repository is developed from the Salesforce CLI base template provided from https://github.com/salesforcecli/plugin-template.

Purpose of this plugin is to provide capability to upload data using Salesforce CLI API and Bulk API 2.0
